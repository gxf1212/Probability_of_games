# 基于蒙特卡罗方法的长春麻将“蛋”产能评估与调度策略研究

> 今天让我们从科研的视角读博（bushi），放松一下。本人新手，欢迎同行批评指正，求轻喷。

各位朋友，你是否曾在牌桌上纠结——手里捏着九筒，到底该不该留？起手三张西风，要不要赌一把单调第四张？今天，我们将用**10万局麻将的真实数据**，为你揭开长春麻将"下蛋"的奥秘！

## 一、关键结论
1. **开局直接有蛋 ≈ 29.72%**，其中 **12.61%** 完全纯净、**17.11%** 需要幺鸡补位，相当于每三局就能亮一次蛋。
2. **多蛋仍稀少但不再是传说**：虽然 29.72% 的手牌能凑出至少一种蛋，但真正能一次抱走 ≥2 只蛋的概率约 **13.3%**（双蛋 9.98%、三蛋 2.76%、四蛋仅 0.48%），再往上迅速掉到万分之几以下级别。
3. **暗杠 / 大蛋的起手奇迹仅 0.24%**，把它们视为奖励事件即可，不必围绕它们设计战术。
4. **单线差一张 → 下一摸**：把余牌视作 123 张等概率牌堆时命中率 **6.50%**，按真实第 14 张则为 **6.52%**，几乎持平，说明“差一张”本身就是低赔率博弈。
5. **双线及以上差一张**：“至少有一条线只差一张就能亮蛋”的情况中，有约28%是“同时差两条线”的，下一摸命中率立刻翻倍到 **13.4%~13.6%**，尤其是“九+喜”组合，理论命中 **13.75%**、实测 **13.83%**。
6. **赖子就是命**：旋风/喜/九三大主力中，赖子贡献分别占到 **81%、73%、73%**；在双线待牌里，90% 以上的成功都靠幺鸡补位，切勿盲丢。

## 二、规则背景：什么是“蛋”？
1. **基础牌量**：长春麻将固定去掉花牌与季节牌，留下 136 张（万、饼、条各 36 张，东南西北 + 中发白各 4 张）；庄家 14 张起手，闲家 13 张。
2. 在长春麻将的生态系统里，“蛋”特指那些能让你保底获得奖励的特殊牌型，这些“蛋”需要特定条件才能“孵化”。**蛋型速览**：
...
3. **赖子设定**：幺鸡是唯一万能宝，可顶替旋风最多 3 张、喜/幺/九最多 2 张；当幺鸡本身直接参与幺蛋时记为纯净，不算赖子。
   - 数据分析进一步揭示了幺鸡的不可替代性：它作为牌桌“生态系”中的**关键物种**，其存在与否直接决定了“蛋”生态系统的多样性与稳定性。失去它，整个做牌策略的“生态位”将变得单一而脆弱。
...
想象一下，我们雇了**4个AI机器人**，不吃不喝连续搓麻将，记录每一副起手牌型。这就是蒙特卡罗模拟的威力！

- 蒙特卡罗抽样次数：**100,000** 副起手；随机种子固定为 **20251204**，这意味着其他科学家完全可以**复现我们的实验**——科学摸蛋，就是这么严谨！
...
<img src="figures/egg_purity.png" alt="纯净赖子柱状图" style="zoom:50%;" />

> 详细百分比见附录表 A-1，可与柱状图逐列对照。

指望起手暗杠制胜，其概率相当于你每天出门买菜都指望捡到一个钱包——**可以怀有梦想，但绝不能列入日常规划**。更务实的策略是，把握好每局约30%的“基础收益”（有蛋概率），像经营一家“良心小店”那样稳健运营。

### 3. 收敛性验证
<img src="figures/convergence.png" alt="收敛性分析" style="zoom:50%;" />
...
<img src="figures/egg_combo_distribution.png" alt="蛋组合分布" style="zoom:50%;" />
...
<img src="figures/next_draw.png" alt="差一张→下一摸概率" style="zoom:50%;" />
...
<img src="figures/multi_wait_combos.png" alt="多线差一张命中率（Top 6）" style="zoom:50%;" />
...
我们通过计算概率来寻求确定性，却又在低概率事件发生时感受到命运的随机性。科学摸蛋，不是为了追求必胜，而是为了在充满不确定性的牌局（和人生）中，做出那个期望值最高的选择。愿你在未来的牌桌上，多一分科学的从容，少一分玄学的焦虑。下次摸到幺鸡时，相信你会想起这篇文章——科学摸蛋，快乐翻倍！

**你在牌桌上遇到过最神奇的"蛋"是什么？欢迎在评论区分享你的“奇迹时刻”！**
